...
###############################################################################
#
#   Build and test for Courts Info Service [telegram-bot] module.
#
...
#   Modified: Dmitrii Gusev, 29.11.2022
#
###############################################################################
...
# - datetime in usual (ISO) format
# datetime=$(date "+%Y.%m.%d_%H.%M.%S")
# - datetime in UNIX timestamp format
# datetime=$(date "+%s")
