...
begin
    ...
    select lsat.court, hub.court_alias, link.check_date, lsat.section_name,
	    ...
	    lsat.hearing_place, lsat.case_info, lsat.stage, lsat.judge, lsat.hearing_result,
	    lsat.decision_link, lsat.case_link, lsat.row_hash, lsat.load_dttm
    from dv_court_cases_l link
	    join dv_court_cases_h hub
		    on hub.court_case_id = link.court_case_id
	    join dv_court_cases_ls lsat IGNORE INDEX (PRIMARY)
