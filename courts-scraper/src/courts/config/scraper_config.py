...
DM_COURT_CASES_TABLES_TO_TRANSFER = [
    {"table_name": "dm_court_cases", "split_key": "id"},
    {"table_name": "dm_court_case_stats"},
    {"table_name": "dm_court_case_stat_details"},
]
BULK_SIZE_ROWS = 50000
